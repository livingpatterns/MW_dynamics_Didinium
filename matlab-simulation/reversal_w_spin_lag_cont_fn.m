...
function [pos,p_hat_list] = reversal_w_spin_lag_cont_fn(U,omega_cell,omega1,omega2,reversal_time,lag_time,a_mid,a_ant,mu,start_time,dt,lambda_mid,lambda_ant,video)
