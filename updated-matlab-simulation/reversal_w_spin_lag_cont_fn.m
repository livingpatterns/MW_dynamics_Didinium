...
% Reversal front propagating around each band, with an anterior lag (Fig. S8).
...
% lag_time delays the anterior reversal relative to the medial band.
...
for ii = 1:N_step+1
    ...
    % end
    % The reversed region grows linearly in azimuth; the anterior front starts later.
    if ii>= idx1
