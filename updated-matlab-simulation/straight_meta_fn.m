...
% Motion of a sphere propelled by two bands of point forces (Fig. 3).
%
% U                 swim speed  
...
%
% Lengths are in um, times in s, and angular rates in rad/s.
% Medial beta/gamma default to 1; anterior values default to medial values.
% pos contains one xyz row per update, without the initial position.
...
for ii = 1:N_step+1
    ...
    % Axial spin moves the force locations but does not turn p_hat.
